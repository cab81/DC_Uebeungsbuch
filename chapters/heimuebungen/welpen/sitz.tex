...
\begin{uebung}{Sitz}{welpen}{Grundkommando}{2}
    ...
    \uebungstrainer{%
        \begin{itemize}[leftmargin=*, itemsep=4pt]
      \item Hand nicht zu hoch halten, so dass der Hund springt.
      \item Auf das Timing bei der Bestätigung achten.
      \item Auf das konsequentes verwenden des Auflösewort achten!
        \end{itemize}
    }
